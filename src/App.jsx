            ...
            <>
                ...
                <div className="container d-flex flex-wrap justify-content-center">
                    <div className="col-6 d-flex justify-content-evenly">
                        ...
                        <button type="button" className="btn btn-info text-light" onClick={handlePeopleButtonClick}>Characters</button>
                    </div>
                ...
                <div className="container d-flex flex-wrap justify-content-center">
                    ...
                    <div >
                        <ul className="col-12 d-flex flex-wrap justify-content-evenly">
                            {filmList.map((films) => (
                                <div key={`film-id-${films.id}`} className="card shadow p-3 mb-5 bg-body rounded col-4 m-4">
                    ...
                    <div>
                        <ul className="col-12 d-flex flex-wrap justify-content-evenly">
                            {peopleList.map((people) => (
                                <div key={`people-id-${people.id}`} className="card shadow p-3 mb-5 bg-body rounded col-4 m-4">
                                    <div className="card-body">
